...
declare module "@salesforce/schema/Individual.DeathDate" {
  const DeathDate:any;
  export default DeathDate;
}
declare module "@salesforce/schema/Individual.ConvictionsCount" {
  const ConvictionsCount:number;
  export default ConvictionsCount;
}
declare module "@salesforce/schema/Individual.ChildrenCount" {
  const ChildrenCount:number;
  export default ChildrenCount;
}
declare module "@salesforce/schema/Individual.MilitaryService" {
  const MilitaryService:string;
  export default MilitaryService;
}
declare module "@salesforce/schema/Individual.IsHomeOwner" {
  const IsHomeOwner:boolean;
  export default IsHomeOwner;
}
declare module "@salesforce/schema/Individual.Occupation" {
  const Occupation:string;
  export default Occupation;
}
declare module "@salesforce/schema/Individual.Website" {
...
declare module "@salesforce/schema/Individual.MasterRecord" {
  const MasterRecord:any;
  export default MasterRecord;
}
declare module "@salesforce/schema/Individual.MasterRecordId" {
  const MasterRecordId:any;
  export default MasterRecordId;
}
declare module "@salesforce/schema/Individual.ConsumerCreditScore" {
  const ConsumerCreditScore:number;
  export default ConsumerCreditScore;
}
declare module "@salesforce/schema/Individual.ConsumerCreditScoreProviderName" {
  const ConsumerCreditScoreProviderName:string;
  export default ConsumerCreditScoreProviderName;
}
declare module "@salesforce/schema/Individual.InfluencerRating" {
  const InfluencerRating:number;
