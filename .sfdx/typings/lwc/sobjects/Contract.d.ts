...
declare module "@salesforce/schema/Contract.BillingStateCode" {
  const BillingStateCode:string;
  export default BillingStateCode;
}
declare module "@salesforce/schema/Contract.BillingCountryCode" {
...
declare module "@salesforce/schema/Contract.ShippingStateCode" {
  const ShippingStateCode:string;
  export default ShippingStateCode;
}
declare module "@salesforce/schema/Contract.ShippingCountryCode" {
...
declare module "@salesforce/schema/Contract.RecordType" {
  const RecordType:any;
  export default RecordType;
}
declare module "@salesforce/schema/Contract.RecordTypeId" {
